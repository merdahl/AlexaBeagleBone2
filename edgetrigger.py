...
GPIO.setup(edge_input, GPIO.IN)
if debug: print "configured GPIO.IN", edge_input

def edgetrigger_start():
    global triggered
    triggered = False

    if debug: print "Waiting for rising edge trigger..."

    GPIO.wait_for_edge(edge_input, GPIO.RISING)

    if debug: print "Received trigger"
